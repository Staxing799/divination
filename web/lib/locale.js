...
export const COPY = {
  en: {
    ...
    heroTitle: 'Decode your next move with Tarot, I Ching, and Eastern insight.',
    heroSubtitle:
    ...
    dashboardSubtitle:
      'Choose a channel, ask your question, and receive a cinematic reading without payment friction.',
    readingType: 'Reading Type',
    tarot: 'Tarot',
    eastern: 'Eastern Fate',
    iching: 'I Ching',
    questionLabel: 'What decision, tension, or opportunity do you want to decode?',
    birthDate: 'Birth Date (for Eastern Fate)',
  ...
  zh: {
    ...
    dashboardSubtitle: '选择占卜通道，输入问题，即刻获得高质量解读。',
    readingType: '占卜类型',
    tarot: '塔罗',
    eastern: '东方命理',
    iching: '易经',
  ...
  es: {
    ...
    heroTitle: 'Descifra tu siguiente paso con Tarot, I Ching y destino oriental.',
    heroSubtitle:
    ...
    dashboardSubtitle: 'Elige un canal, pregunta y recibe una lectura cinematica sin friccion de pago.',
    readingType: 'Tipo de Lectura',
    tarot: 'Tarot',
    eastern: 'Destino Oriental',
    iching: 'I Ching',
    questionLabel: 'Que decision, tension u oportunidad deseas descifrar?',
    birthDate: 'Fecha de nacimiento (destino oriental)',
  ...
  ja: {
    ...
    heroTitle: 'タロット・易経・東洋運勢で、次の一手を解読する。',
    heroSubtitle:
    ...
    dashboardSubtitle: 'チャネルを選び、質問し、支払いフリクションなしで鑑定を受け取ります。',
    readingType: '鑑定タイプ',
    tarot: 'タロット',
    eastern: '東洋運勢',
    iching: '易経',
